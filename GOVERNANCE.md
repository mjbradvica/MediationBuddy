...
**Primary Maintainer**: GitHub @mjbradvica

- **Email**: <simplexsoftwarellc@gmail.com>
- **Timezone**: Eastern
- **Availability**: Best response times on weekdays during normal business hours
...
- **Direct Contact**: Use email for security issues or private matters

## Project Goals

The goals of ClearDomain are the same as Simplex Software. To provide the best open source project for the .NET landscape.

## Response Times

I aim to respond to:

- Security issues: Within 24 hours or next business day
